// Package chroma provides primitives to interact with the Chroma HTTP API.
//
...
type ServerInterface interface {
	...
	DeleteCollection(ctx echo.Context, collectionName string) error
	// Get Collection
	// (GET /api/v1/collections/{collection_name})
	GetCollection(ctx echo.Context, collectionName string) error
	// Update Collection
	// (PUT /api/v1/collections/{collection_name})
	UpdateCollection(ctx echo.Context, collectionName interface{}) error
	// Add
	// (POST /api/v1/collections/{collection_name}/add)
	Add(ctx echo.Context, collectionName string) error
	// Count
	// (GET /api/v1/collections/{collection_name}/count)
	Count(ctx echo.Context, collectionName string) error
	// Create Index
	// (POST /api/v1/collections/{collection_name}/create_index)
	CreateIndex(ctx echo.Context, collectionName string) error
	// Delete
	// (POST /api/v1/collections/{collection_name}/delete)
	Delete(ctx echo.Context, collectionName string) error
	// Get
	// (POST /api/v1/collections/{collection_name}/get)
	Get(ctx echo.Context, collectionName interface{}) error
	// Get Nearest Neighbors
	// (POST /api/v1/collections/{collection_name}/query)
	GetNearestNeighbors(ctx echo.Context, collectionName interface{}) error
	// Update
	// (POST /api/v1/collections/{collection_name}/update)
	Update(ctx echo.Context, collectionName string) error
	// Persist
	// (POST /api/v1/persist)
	Persist(ctx echo.Context) error
	// Raw Sql
	// (POST /api/v1/raw_sql)
	RawSql(ctx echo.Context) error
	// Reset
	// (POST /api/v1/reset)
	Reset(ctx echo.Context) error
	// Version
	// (GET /api/v1/version)
...
func (w *ServerInterfaceWrapper) DeleteCollection(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithLocation("simple", false, "collection_name", runtime.ParamLocationPath, ctx.Param("collection_name"), &collectionName)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter collection_name: %s", err))
	}

	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.DeleteCollection(ctx, collectionName)
	return err
}
...
func (w *ServerInterfaceWrapper) GetCollection(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.GetCollection(ctx, collectionName)
	return err
}
...
func (w *ServerInterfaceWrapper) UpdateCollection(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.UpdateCollection(ctx, collectionName)
	return err
}
...
func (w *ServerInterfaceWrapper) Add(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.Add(ctx, collectionName)
	return err
}
...
func (w *ServerInterfaceWrapper) Count(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.Count(ctx, collectionName)
	return err
}

// CreateIndex converts echo context to params.
func (w *ServerInterfaceWrapper) CreateIndex(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "collection_name" -------------
	var collectionName string
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.CreateIndex(ctx, collectionName)
	return err
}
...
func (w *ServerInterfaceWrapper) Delete(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.Delete(ctx, collectionName)
	return err
}
...
func (w *ServerInterfaceWrapper) Get(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.Get(ctx, collectionName)
	return err
}

// GetNearestNeighbors converts echo context to params.
func (w *ServerInterfaceWrapper) GetNearestNeighbors(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "collection_name" -------------
	var collectionName interface{}
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.GetNearestNeighbors(ctx, collectionName)
	return err
}
...
func (w *ServerInterfaceWrapper) Update(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.Update(ctx, collectionName)
	return err
}

// Persist converts echo context to params.
func (w *ServerInterfaceWrapper) Persist(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.Persist(ctx)
	return err
}

// RawSql converts echo context to params.
func (w *ServerInterfaceWrapper) RawSql(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.RawSql(ctx)
	return err
}

// Reset converts echo context to params.
func (w *ServerInterfaceWrapper) Reset(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.Reset(ctx)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/api/v1", wrapper.Root)
	router.GET(baseURL+"/api/v1/collections", wrapper.ListCollections)
	router.POST(baseURL+"/api/v1/collections", wrapper.CreateCollection)
	router.DELETE(baseURL+"/api/v1/collections/:collection_name", wrapper.DeleteCollection)
	router.GET(baseURL+"/api/v1/collections/:collection_name", wrapper.GetCollection)
	router.PUT(baseURL+"/api/v1/collections/:collection_name", wrapper.UpdateCollection)
	router.POST(baseURL+"/api/v1/collections/:collection_name/add", wrapper.Add)
	router.GET(baseURL+"/api/v1/collections/:collection_name/count", wrapper.Count)
	router.POST(baseURL+"/api/v1/collections/:collection_name/create_index", wrapper.CreateIndex)
	router.POST(baseURL+"/api/v1/collections/:collection_name/delete", wrapper.Delete)
	router.POST(baseURL+"/api/v1/collections/:collection_name/get", wrapper.Get)
	router.POST(baseURL+"/api/v1/collections/:collection_name/query", wrapper.GetNearestNeighbors)
	router.POST(baseURL+"/api/v1/collections/:collection_name/update", wrapper.Update)
	router.POST(baseURL+"/api/v1/persist", wrapper.Persist)
	router.POST(baseURL+"/api/v1/raw_sql", wrapper.RawSql)
	router.POST(baseURL+"/api/v1/reset", wrapper.Reset)
	router.GET(baseURL+"/api/v1/version", wrapper.Version)
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+xa31PjNhD+VzxqHz0k0D7ljXKUMkOBAr0+MExGWJugG9syknxphvH/3pHkH5KsGNLJ",
	"keHOT5zt1erTfp92V9G9oIRlBcshlwLNXpBIniDD+p/HhJxmj0AIzZfqueCsAC4p6K+EJWXWjML5+mqB",
	"ZvcvSK4LQDMkJFejqvgFUQmZMqri5iPmHK9R9RAjSWWq3nxqnVUxgmZS7doeXlufdga+zxhRshNE50Rj",
	"oXnCQSGb05zAv3rhsMBlKtFM8hKsAY1ldK4tW9+PjKWAc+UtA4kJlthDuBFP3KJnj18gkQ7CP1tnVRUj",
	"Ds8l5UDQ7N4OoGXv0Bn7jmN0wgFLOGFpComkLO9TvgQ5Z3yeaEMnFAucCisWZyCjKx4Zj4ORUF78BYXA",
	"5TgD2/ZSPcc+t14c9CArAr0VBib6BClIGNB9ra+ALJVk+npcPQF3oP+jXwSm1pbzZl/1hkTNJumPtUD4",
	"+APznIHc4fponqQlceVwbyk9tjLFQ9z6RZCXmbLsvjo7P3ZdUCFxnoARtLeh7S2oofRBpjSjTkQv9IvW",
	"kOYSlsCVKVssBDi2V+ZNyFgw7pjequcAwncWgcNwYJI/7u6uP+OUEqy2wSnnjAcSPEhMU1sL6GcOCzRD",
	"P026mjGpC8bE9+doUnvyabEsQoACuP8qga+HtLuFFj1R7UeX+ZyDKFMpHMiH027sZXRTW4T096wCMn+1",
	"YOq4RYNls1Voi8J2sIVcN48f1q6duHvLevDWMqjuG7y6fU776uB4NRfmQ+PsBq8iZRuqJJaNY9JN9HdB",
	"XqmYOazmoVJ3CatosNzBat4rebCKNpa9xqgHaSPssbX7KK2dy+2g9F9N6ilLnIw+FEs/3TxYWC5Ygl19",
	"tSxlYul2dULgJYSqonnRmWrM0Z16+1prp9Zhpqotrei9Wkgqzf6C2XP/joU8vj5HMfoKXOjNjKYHhwdT",
	"3RMUkOOCohn65WB6cIRiVGD5pAM4wQWdfD2s22P1R4Vbz35OVPZgTOU7DqJguTAkHE2n6k/CclknTVwU",
	"KTURnXwRJpOYwqq0o/ASEAmnhUkz6LZMEhBiUaaqPGjPOkSizDLM18286lUNcJK0OUFsBHtBhTyx7PaA",
	"W0GIbAxVjAomAmAD3bxSCAj5GyPrbYAO9jW9aSpXiypVVO8TqBj9enS0s4WFeq4Aks4kamxsvkx4Iic+",
	"QdFNXroHXdsqk3HVcaVPrjnGOOQWmOMMJHBhMqsCp7Yhak6HyJsA+TTFVmTaM2E7ZlNxffhxyTUsOOTG",
	"4cxxBnIka79knYH0mCrKAFOBDvF9yKrJ2X2G7q1ozNC2Lkx4/leGnmBCdA8ZLMDHhOx7p+9eTM6vpG8S",
	"0uGPIiTF99ulk7DSwA7WixP9dawT++jYdOi3IFJ3eN0heagbb87HI637asQNA29nt2vAw7yaFvD7y/P+",
	"PcnYM/Qb/y1kVCf5sIbOQH78LtO5UxnV4p08tpCK/nF/UCyXgDkIeQl0+fTIuPj44vEuLUb5+AfXmvKo",
	"4/ztgir1AWezoswB6PsrYf59wKiq/rHXkVEBXFAxUKiua4M9/O7dTG3jtS4sw3jbq8lvIa/a+agq51ql",
	"vjB2aAIx1P3cgPnfI+9/BaQntpG2V1sbTuWf6+97ANtMXVVV9V8AAAD//0QfmuuUKAAA",
}
